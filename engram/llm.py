"""
engram/llm.py
Sends retrieved terminal context to a local or remote LLM and streams
back an answer. Shows a spinner while waiting so the user knows it is
working and hasn't hung.
"""
...
class _Spinner:
    ...
    Call .stop() to clear it before writing any output.
    """
    _FRAMES = ["⠋", "⠙", "⠹", "⠸", "⠼", "⠴", "⠦", "⠧", "⠇", "⠏"]
