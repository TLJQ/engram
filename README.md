...
engram logs every command you run — and its **output** — into a local SQLite database. When you need to remember something, just ask.
...
**Everything stays on your machine.** No cloud, no tracking, no data leaves your computer (unless you set ANTHROPIC_API_KEY, then only relevant context snippets are sent).

---

## Demo

![engram demo](https://github.com/TLJQ/engram/raw/main/demo.gif)

*Ask questions about your terminal history and get answers.*

---

## The Problem

Your shell only saves commands, not outputs. Error messages, API responses, build logs — gone the moment they scroll off screen.
...
| 🔒 **Secret redaction** | Strips out API keys, tokens, passwords before saving (15+ patterns) |
